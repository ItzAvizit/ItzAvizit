...
<svg width="100%" height="200" viewBox="0 0 800 200" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    ...
    <linearGradient id="bg-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="100%" stop-color="#040e1e"/>
    </linearGradient>

    <!-- Cyan Glow -->
    <radialGradient id="cyan-glow" cx="30%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#06b6d4" stop-opacity="0.35"/>
      <stop offset="100%" stop-color="#06b6d4" stop-opacity="0"/>
    </radialGradient>

    <!-- Emerald Glow -->
    <radialGradient id="emerald-glow" cx="70%" cy="50%" r="50%">
  ...
  <!-- Ambient Lights -->
  <circle cx="230" cy="100" r="160" fill="url(#cyan-glow)"/>
  <circle cx="570" cy="100" r="160" fill="url(#emerald-glow)"/>

  <!-- Decorative Tech Grid Lines -->
  <path d="M0 40 H800 M0 160 H800" stroke="#0e3a5d" stroke-width="0.75" stroke-dasharray="6 6" opacity="0.4"/>
  <path d="M120 0 V200 M680 0 V200" stroke="#0e3a5d" stroke-width="0.75" stroke-dasharray="6 6" opacity="0.4"/>

  <!-- Avatar/Logo Icon Container -->
  <g transform="translate(150, 48)">
    <rect width="104" height="104" rx="26" fill="#081e36" stroke="url(#icon-grad)" stroke-width="2.5"/>
    <!-- Stylized 'A' Logo for Avizit -->
    <path d="M52 28 L30 76 H42 L47 64 H57 L62 76 H74 L52 28 Z M52 42 L55 54 H49 L52 42 Z" fill="url(#text-grad)"/>
  </g>
...
<a href="#">
  <img src="https://img.shields.io/badge/COMMISSIONS-AVAILABLE-0a2540?style=for-the-badge&logo=sparkles&logoColor=34d399&labelColor=040e1e" alt="Commissions"/>
</a>
<a href="https://discord.gg">
  <img src="https://img.shields.io/badge/DISCORD-CONNECT-0a2540?style=for-the-badge&logo=discord&logoColor=38bdf8&labelColor=040e1e" alt="Discord"/>
</a>
...
status:   "⚡ Crafting scalable backends & clean web interfaces"
motto:    "Building robust code from low-level systems to modern web applications."
```
